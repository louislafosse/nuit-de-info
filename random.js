var Sentences = ["La fellation c'est bien mais avec preservatif c'est mieux",
"Se faire dépister! Pour profiter de la meilleure expèrience sexuelle\nLes MST peuvent être transmises lors d’une fellation sans protection. Le VIH peut être transmis lorsque l’une des 2 personnes est séropositive et qu’une plaie ouverte soit présente dans la bouche.",
...
"29% des personnes seropositives sont dépistées à un stade avancé de l'infection\n",
"Parlez à vos partenaires\n",
"protègez vos muqueuses\n",
"Vous n'êtes pas surs ? Contactez la ligne Azur\nLa ligne azur est un numéro que vous pouvez appeler si vous possédez des questions ou si vous vous sentez mal, ils ne sont pas là pour vous juger mais pour vous écouter et vous conseiller. Joignez-les aux 0 810 20 30 40.",
